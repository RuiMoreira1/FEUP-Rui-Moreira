...
export class MybodySphere extends CGFobject {
  /**
   * @method constructor
   ...
   */
  constructor(scene, slices, stacks, texture,scalex,scaley,scalez) {
    super(scene);
  ...
  initBuffers() {
    ...
    for (let latitude = 0; latitude <= this.latDivs; latitude++) {
      ...
      for (let longitude = 0; longitude <= this.longDivs; longitude++) {
        ...
        var x = Math.cos(theta) * sinPhi * this.changeX;
        var y = cosPhi * this.changeY;
        var z = Math.sin(-theta) * sinPhi * this.changeZ;
